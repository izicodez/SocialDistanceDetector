...
VIOLATION_TIME_SETTING=15   #Main message time
VIOLATION_TIME_SETTING_2=10 #Spam him after .. minutes
stop.start()
###
if client_socket:
    message=["Room1", 400,int(f"{VIOLATION_COUNT_SETTING}"),int(f"{VIOLATION_TIME_SETTING}"),int(f"{VIOLATION_TIME_SETTING_2}")]
